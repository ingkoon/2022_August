...
public class Main_3056V2 {
	...
	static void runHedge(int r, int c, int nr, int nc) {
		forest[nr][nc] = "S";
		visited[nr][nc] = visited[r][c] + 1;
		queue.offer(new int[] {nr, nc});
	}
	static void runWater(int r, int c, int nr, int nc) {
		forest[nr][nc] = "*";
		queue.offer(new int[] {nr, nc});
	}
}
